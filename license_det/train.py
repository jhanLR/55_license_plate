...
os.environ["WANDB_API_KEY"] = '1109a429fc044fc47e145707874eaba168bb8ca7'
os.environ["WANDB_MODE"] = "online" # online / offline / dryrun
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/license_plate.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/car_plate/car_plate.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/car_plate/hyp_car_plate.yaml', help='hyperparameters path')
